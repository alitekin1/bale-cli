...
from bale_cli.commands import auth, sync, messages, send, chats, contacts, groups, doctor, typing, admin, serve
...
@click.pass_context
def main(ctx, store, profile, json_output, events, timeout, read_only):
...
main.add_command(typing.typing)
